...
const Card = () => {
  return (
    <div className="card">
      ...
      <p className="heading md:text-5xl font-bold mb-5 md:mb-0">Industrial and Electrical goods</p>
      <p className='text-lg md:text-2xl font-medium mb-10 md:mb-5'>Deals in Pipes, Boiler Fittings ,Bearings, Industrial Oils and electrical components   </p>
...
const Navbar = () => {
  return (
    ...
    <nav className="nav">
      <div className="inline-block pt-3 md:pt-0">
